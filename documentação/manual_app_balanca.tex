...
\item Abra o executável \texttt{app\_principal.exe}.
...
\item Abra o aplicativo SISAQUI executando o arquivo \texttt{app\_principal.exe}.
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item Possui métodos públicos para ser atualizada pelo Controller (ex: \texttt{atualizar\_peso\_display()}).
    \end{itemize}
